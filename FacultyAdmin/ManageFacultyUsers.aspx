<%@ Page 
    Title ="Manage Faculty Users"
    Language="C#"
    AutoEventWireup="true" 
    MasterPageFile="~/Site.Master"
    CodeBehind="ManageFacultyUsers.aspx.cs" 
    Inherits="OurWebsite.FacultyAdmin.ManageFacultyUsers" %>
   ...
   <tr>
       <td>
           &nbsp;Select Role:
            ...
            <asp:ListItem Value="Faculty Admin">Faculty Admin</asp:ListItem>
        </asp:DropDownList>
            </td>
        </tr>  
    </table>
...
<asp:Panel runat="server" ID="PnlManage" Visible="False">
        ...
        <asp:GridView runat="server" ID="GridView1" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" DataKeyNames="Name,UserID">
            <Columns>
