/****************************** Module Header ******************************\
* The class FilesObject supplies following features:
* 1. Create a folder
* 2. Delete a folder  
* 3. Rename a folder
* 4. Delete a file
    ...
    internal class FilesObject
    {
                ...
                if (Directory.Exists(folderPath))
                {
                    return string.Format(
                        ...
                        " location \"{1}\".", folderName, folderLocation.Replace(
                            Files.MyFiles.RootPath, "FileServerRoot"));
                }
        ...
        public static string DeleteFolder(string folderPath)
        {
            ...
            try
            {
                ...
                if (!Directory.Exists(folderPath))
                {
                    return string.Format("There is no folder with the name \"{0}\" in the location \"{1}\".",folderName, folderLocation.Replace(Files.MyFiles.RootPath, "FileServerRoot"));
                }
